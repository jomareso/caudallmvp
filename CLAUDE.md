...
7. **Prioridad de dispositivo:** empleado mobile-first, RRHH y admin desktop-first pero funcionales en móvil (actualizado — antes admin era desktop-only; ver ADR-007 en `docs/decisions.md`).
